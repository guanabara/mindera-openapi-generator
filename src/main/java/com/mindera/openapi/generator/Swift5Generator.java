...
public class Swift5Generator extends DefaultCodegen implements CodegenConfig {
    private static final Logger LOGGER = LoggerFactory.getLogger(Swift5Generator.class);
    ...
    public String getHelp() {
        return "Generates a Swift 5.x client library for Minders.";
    }
        ...
        if (allDefinitions != null) {
            ...
            while (parentSchema != null) {
                ...
                final CodegenModel parentCodegenModel = super.fromModel(codegenModel.parent,
                        parentModel);
                codegenModel = Swift5Generator.reconcileProperties(codegenModel, parentCodegenModel);
