package com.mindera.openapi.generator.swift5.options;
...
public class MinderaSwift5OptionsProvider implements OptionsProvider {
    ...
    public Map<String, String> createOptions() {
        ...
        return builder.put(CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG, SORT_PARAMS_VALUE)
                ...
                .put(Swift5Generator.PROJECT_NAME, PROJECT_NAME_VALUE)
                .put(Swift5Generator.RESPONSE_AS, RESPONSE_AS_VALUE)
                .put(CodegenConstants.NON_PUBLIC_API, NON_PUBLIC_API_REQUIRED_VALUE)
                .put(Swift5Generator.OBJC_COMPATIBLE, OBJC_COMPATIBLE_VALUE)
                .put(Swift5Generator.LENIENT_TYPE_CAST, LENIENT_TYPE_CAST_VALUE)
                .put(Swift5Generator.POD_SOURCE, POD_SOURCE_VALUE)
                .put(CodegenConstants.POD_VERSION, POD_VERSION_VALUE)
                .put(Swift5Generator.POD_AUTHORS, POD_AUTHORS_VALUE)
                .put(Swift5Generator.POD_SOCIAL_MEDIA_URL, POD_SOCIAL_MEDIA_URL_VALUE)
                .put(Swift5Generator.POD_LICENSE, POD_LICENSE_VALUE)
                .put(Swift5Generator.POD_HOMEPAGE, POD_HOMEPAGE_VALUE)
                .put(Swift5Generator.POD_SUMMARY, POD_SUMMARY_VALUE)
                .put(Swift5Generator.POD_DESCRIPTION, POD_DESCRIPTION_VALUE)
                .put(Swift5Generator.POD_SCREENSHOTS, POD_SCREENSHOTS_VALUE)
                .put(Swift5Generator.POD_DOCUMENTATION_URL, POD_DOCUMENTATION_URL_VALUE)
                .put(Swift5Generator.SWIFT_USE_API_NAMESPACE, SWIFT_USE_API_NAMESPACE_VALUE)
