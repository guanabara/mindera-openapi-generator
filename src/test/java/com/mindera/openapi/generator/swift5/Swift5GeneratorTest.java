...
public class Swift5GeneratorTest {

    Swift5Generator swiftCodegen = new Swift5Generator();
    ...
    public void binaryDataTest() {
        ...
        final OpenAPI openAPI = TestUtils.parseFlattenSpec("src/test/resources/binaryDataTest.json");
        final DefaultCodegen codegen = new Swift5Generator();
    ...
    public void dateTest() {
        final OpenAPI openAPI = TestUtils.parseFlattenSpec("src/test/resources/datePropertyTest.json");
        final DefaultCodegen codegen = new Swift5Generator();
        codegen.setOpenAPI(openAPI);
    ...
    public void testPodAuthors() throws Exception {
        ...
        swiftCodegen.additionalProperties().put(Swift5Generator.POD_AUTHORS, openAPIDevs);

        // When
        swiftCodegen.processOpts();

        // Then
        final String podAuthors = (String) swiftCodegen.additionalProperties().get(Swift5Generator.POD_AUTHORS);
